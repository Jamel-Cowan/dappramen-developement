import { Avatar, Box, Button, Container, Flex, Heading, Link, Text, useColorMode,ColorMode } from "@chakra-ui/react";
...
export const Navbar = () => {
    ...
    return (
        ...
        <Box maxW={"1200px"} m={"auto"} py={"10px"} px={"40px"} boxShadow={"md"} >
